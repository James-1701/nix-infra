      ...
      (lib.mkIf (lineage.has.usage "AeroThemePlasma") {
        ...
        programs.plasma = {
          workspace = {
            ...
            # theme = "Seven-Black"; # TODO FIX!
            # lookAndFeel = "authui7"; # TODO FIX!
            # iconTheme = "Windows 7 Aero"; TODO FIX!
            # splashScreen.theme = lib.mkForce "authui7"; TODO FIX!
            # windowDecorations = { TODO FIX!
            #   theme = "SMOD";
            #   library = "none";
            # };
          };
